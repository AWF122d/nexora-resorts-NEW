...
export default function RobloxLinking() {
  ...
  return (
    <div data-testid="roblox-linking-page" className="space-y-8">
      <div>
        <div className="text-[11px] uppercase tracking-[0.3em] text-[var(--text-2)]">Account</div>
        ...
        <p className="text-[var(--text-2)] mt-2 max-w-2xl">
          ...
          Roblox group will sync automatically.
        </p>
      </div>
      ...
      <div className="surface p-6">
        {user?.roblox_username ? (
          ...
          <div>
            <p className="text-sm text-[var(--text-2)]">No Roblox account linked.</p>
            <button onClick={start} disabled={!oauth?.configured}
              data-testid="roblox-connect-btn"
              className="btn-discord mt-4 rounded-md px-5 py-2.5 text-sm inline-flex items-center gap-2 disabled:opacity-60">
